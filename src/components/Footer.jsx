  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(22,163,74,0.45), transparent)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 100%, rgba(22,163,74,0.05) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: "#475569" }}>
                  Fixture Tracker · Bangladesh Time
                </div>
              </div>
            </div>
            <p className="text-xs leading-relaxed" style={{ color: "#475569" }}>
              All match times displayed in Bangladesh Standard Time (UTC+6). The
              ultimate fixture companion for the 2026 World Cup.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                {
                  flag: <FlagIcon teamName="USA" size={20} />,
                  country: "USA",
                  venues: "11 venues",
                },
                {
                  flag: <FlagIcon teamName="Mexico" size={20} />,
                  country: "Mexico",
                  venues: "3 venues",
                },
                {
                  flag: <FlagIcon teamName="Canada" size={20} />,
                  country: "Canada",
                  venues: "2 venues",
                },
              ].map((h) => (
        ...
        <div
          className="mt-6 flex flex-col md:flex-row items-center justify-between gap-2 text-xs"
          style={{ color: "#475569" }}
        >
          <span>© 2026 FIFA World Cup Fixture Tracker. Personal use only.</span>
          <div className="flex items-center gap-1.5">
            Made with{" "}
            <span style={{ color: "#ef4444", fontSize: "1rem" }}>❤️</span> by{" "}
            <a
